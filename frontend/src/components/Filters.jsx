            ...
            <div className="flex gap-4">
                {viewMode === "weekly" && (
                    <>
                        ...
                        <select
                            className="border border-border bg-card text-foreground p-2 w-40 shadow-lg rounded"
                            value={selectedMonth}
                ...
                {viewMode === "yearly" ? (
                    <div className="flex gap-4">
                        <div>
                            <label className="text-sm font-medium p-2 text-muted-foreground">From Year</label>
                            <select
                                className="border border-border bg-card text-foreground p-2 w-40 shadow-lg rounded"
                                value={fromYear}
                        ...
                        <div>
                            <label className="text-sm font-medium p-2 text-muted-foreground">To Year</label>
                            <select
                                className="border border-border bg-card text-foreground p-2 w-40 shadow-lg rounded"
                                value={toYear}
