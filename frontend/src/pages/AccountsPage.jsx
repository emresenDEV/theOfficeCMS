                ...
                <div className="space-y-4">
                    {filteredAccounts.map(account => (
                        <div 
                            ...
                            className="border border-border p-4 rounded-lg shadow flex justify-between items-center bg-card"
                        >
                            ...
                            <div className="text-left">
                                ...
                                <p className="text-muted-foreground"><span className="font-medium">Address:</span> {account.address}, {account.city}, {account.state} {account.zip_code}</p>
                                ...
                                {account.sales_rep ? (
                                    ...
                                    <p className="text-muted-foreground">No assigned sales representative.</p>
                                )}
                            </div>
