    ...
    <div className="mx-auto max-w-6xl px-4 py-4 sm:px-6 sm:py-6">
      <div className="rounded-lg border border-border bg-card p-4 sm:p-6 shadow-lg">
        <div className="flex flex-wrap items-center justify-between gap-4">
          ...
          <button
            className="w-full rounded-md border border-border px-4 py-2 text-sm font-semibold text-foreground hover:bg-muted sm:w-auto"
        ...
        <div className="mt-6">
          ...
          <div className="mt-3 overflow-x-auto rounded-lg border border-border">
            {loading ? (
              <div className="p-4 sm:p-6 text-sm text-muted-foreground">Loading pipeline...</div>
            ) : rows.length === 0 ? (
              <div className="p-4 sm:p-6 text-sm text-muted-foreground">No invoices in this stage yet.</div>
            ) : (
