...
## Update Backend Code & Restart Flask (from VSCode Terminal)

```bash
# Step 1: Make your code changes in VSCode on MacBook Pro
...
## Notes
- All these commands can be run in **VSCode's integrated terminal** (View > Terminal or Ctrl+`)
- Flask will continue running in the background after you detach from tmux
- You can close your MacBook Pro terminal or VSCode - Flask stays running on Mac Mini
